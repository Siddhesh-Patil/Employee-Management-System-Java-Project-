...
public class DeleteEmployee extends JFrame implements ActionListener {
    ...
    DeleteEmployee() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/i9.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/i3.jpg"));
        Image i5 = i4.getImage().getScaledInstance(600, 400, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel image1 = new JLabel(i6);
        image1.setBounds(350, 0, 600, 400);
        image.add(image1);
